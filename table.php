    ...
    <div id="mySidenav" class="sidenav">
        ...
        <div class="text-center">
            ...
            <div class="avatar-upload">
                ...
                <h3 class="profile-username text-center fw-bold text-primary text-uppercase fs-5 pt-4">
        ...
        <form action="Logout.php" method="post">
            <button class="tablinks text-center text-dark" name="Logout" type="submit"><i class="fas fa-sign-out"></i>
                Logout</button>
        </form>
...
<div>
 ...
 <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
        <div class="container-fluid">
            <a class="navbar-brand text-center" href="#">TCPL</a>
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                <span class="navbar-toggler-icon"></span>
            </button>

            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav navbar-sidenav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <h3 class="profile-username text-center fw-bold text-light text-uppercase fs-5 pt-4 mt-5">
                            <?php
                        ...
                        <a class="nav-link " aria-current="page" href="deshboard1.php">
                            <span class="nav-link text-light  fw-bold">Map</span>
                        </a>
                    </li>
                    <li class="nav-item">
  ...
  <a href="deshboard1.php" > <button id="closeBtn">X</button></a>
    <div id="table-container">
    
        <table id="filtered-data-table">
            <thead>
                <tr class="width: fit-content; block-size: fit-content;">
                    <th>Column 1</th>
                    <th>Column 2</th>
                    <th>Column 3</th>
